 ...
 * restrictions.
 */
class SiblingListPluginLocator
{
    /**
    ...
    public function resolveForPage(ContentObjectRenderer $contentObject, int $pageId): ?SiblingListPluginContext
    {
        ...
        return new SiblingListPluginContext($editorFilter, $storagePageIds);
    }
}
