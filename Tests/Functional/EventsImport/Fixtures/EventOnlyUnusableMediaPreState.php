...
return [
    ...
    'tx_thuecat_import_configuration' => [
        0 => [
            ...
            'crdate' => 1613400558,
            'disable' => '0',
            'title' => 'Event only unusable media',
            'type' => 'static',
                ...
                <data>
                    <sheet index="sDEF">
                        <language index="lDEF">
                            ...
                            <field index="urls">
                                <el index="el">
                                    <field index="evt-only-unusable-media">
                                        <value index="url">
                                            <el>
                                                <field index="url">
                                                    <value index="vDEF">https://cdb.int.thuecat.org/api/resources/e_only_unusable_media-tdm</value>
                                                </field>
                                            </el>
                                        </value>
