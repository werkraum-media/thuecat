...
// Pre-state for the media reap on a single-field owner. The event already holds
// two references in `images`; the fixture it re-imports supplies only the first,
// so the second must be reaped. Both files are pre-seeded, so the run fetches
// the graph but downloads nothing.
return [
    'pages' => [
        0 => [
            'uid' => '2000',
