...
return [
    ...
    'sys_category' => [
        ...
        // Imported earlier from a type the current payload no longer names.
        [
            'uid' => '102',
            'pid' => '20',
            'parent' => '100',
            'title' => 'Musikveranstaltung',
            'remote_id' => 'type:schema:MusicEvent',
        ],
        // Editor's own category: no remote_id, so outside the importer's reach.
        [
            'uid' => '103',
            'pid' => '20',
            'parent' => '100',
            'title' => 'Redaktionsempfehlung',
        ],
    ],
