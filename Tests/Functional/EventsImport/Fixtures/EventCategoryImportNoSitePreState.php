...
// storagePid 500 is a folder at the tree root with no site config → the import
// must abort in the pre-flight validator (StoragePidConfigurationException)
...
return [
    'pages' => [
        [
            ...
            'title' => 'Site-less storage folder',
        ],
    ],
