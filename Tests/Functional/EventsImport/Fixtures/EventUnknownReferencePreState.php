...
// Seeded with a remote_id the payload does not reference, so the miss is the
// lookup's and not an empty table's.
return [
    'pages' => [
        0 => [
            'uid' => '2000',
                ...
                <data>
                    <sheet index="sDEF">
                        <language index="lDEF">
                            ...
                            <field index="urls">
                                <el index="el">
                                    <field index="evt-unknownref">
                                        <value index="url">
                                            <el>
                                                <field index="url">
                                                    <value index="vDEF">https://cdb.int.thuecat.org/api/resources/e_unknownref-hubev</value>
                                                </field>
                                            </el>
                                        </value>
