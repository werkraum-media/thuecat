...
// group -> set -> term, three levels below the anchor (200). Synthetic: live
// data only ever nests two deep.
return [
    'pages' => [
        [
            'uid' => '1',
    ...
    'tx_thuecat_import_configuration' => [
        [
            ...
            'pid' => '0',
            'disable' => '0',
            'title' => 'Deep keyword nesting import',
            'type' => 'static',
                ...
                <data>
                    <sheet index="sDEF">
                        <language index="lDEF">
                            ...
                            <field index="urls">
                                <el index="el">
                                    <field index="deep-poi">
                                        <value index="url">
                                            <el>
                                                <field index="url">
                                                    <value index="vDEF">https://thuecat.org/resources/deep-poi</value>
                                                </field>
                                            </el>
                                        </value>
