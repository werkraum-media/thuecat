...
// Category anchor (100) and keyword anchor (200) are separate roots on separate
// storage pages, so a test can prove keywords never land under the category one.
return [
    'pages' => [
        [
            'uid' => '1',
                        ...
                        <language index="lDEF">
                            ...
                            <field index="urls">
                                <el index="el">
                                    ...
                                    <field index="poi-second">
                                        <value index="url">
                                            <el>
                                                <field index="url">
                                                    <value index="vDEF">https://thuecat.org/resources/second-root-poi</value>
                                                </field>
                                            </el>
                                        </value>
                                        <value index="_TOGGLE">0</value>
